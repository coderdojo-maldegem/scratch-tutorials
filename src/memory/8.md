...
Dat doen we door de elementen van onze lijst *uiterlijken* te verwisselen.

Maak 3 nieuwe variabelen aan, kies telkens *voor alle sprites*, en noem ze
<code class="b xl">(UiterlijkBuffer)</code>, <code class="b xl">(wissel1)</code> en <code class="b xl">(wissel2)</code>.
